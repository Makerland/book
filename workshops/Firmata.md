...
Hint: You should see the LED flash a few times and then it should stop.
...
Hint: Does your button seem a bit slow to react to you pushing it?  This is a know issue with the Artoo library, just press and hold the button a little longer than you would expect to.
...
1. Build a simple web interface for your Light Switch.
...
Bonus: Integrate either SendGrid or Twilio’s API so you can control you light via email or SMS message.

2. Explore interacting with some of the other available components
